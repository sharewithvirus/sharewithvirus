...
const StaffDepartmentChecklistHistory = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        ...
        const check = res.data.department.checklists;
        setDepartmentData(ddata);
        setBatchData(bData);
        setChecklistText(check);
      })
      .catch((e) => {
        console.log("Something Went Wrong");
      });
                  ...
                  <div className={`my-4 ${styles.ddetail}`}>
                    <div className="row">
                      ...
                      <div
                        ...
                        onClick={() =>
                          navigate(
                            `/user/${params.id}/staff/${params.sid}/department/checklist/${params.did}/batch/${params.bid}`
                          )
                        }
                      >
                        <span>
                      ...
                      <div
                        ...
                        onClick={() =>
                          navigate(
                            `/user/${params.id}/staff/${params.sid}/department/fee/${params.did}/batch/${params.bid}`
                          )
                        }
                      >
                        <span>
                          ...
                          <div className="col-12 col-md-6 mb-2">
                            ...
                            >
                              <p className={styles.dlogoText}>
                                ...
                                />
                                <br />
                                <small>{ct.checklistName}</small>
                                <br />
                                {ct.checklistFees === "Yes" ? (
                                  <span
                                    className={`${styles.dlogodesc} text-success`}
                                  >
                                    Paid
                                  </span>
                                ) : (
                                  <span
                                    className={`${styles.dlogodesc} text-danger`}
                                  >
                                    Not Paid
                                  </span>
                                )}
...
export default StaffDepartmentChecklistHistory;
