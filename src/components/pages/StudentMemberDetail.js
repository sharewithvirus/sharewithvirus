...
const StudentMemberDetail = () => {
  ...
  useEffect(() =>{
      ...
      axios.get(`${requestURL}/student/${params.sid}/attendence`)
      .then((res) =>{
        // console.log(res)
      })
      .catch((e) =>{
              ...
              <div className={`h-100 ${styles.about}`} style={{ marginTop: "24px" }}>
                ...
                <div className={`${styles.outer2} mt-4`}>
                  ...
                  <div className={`my-4 ${styles.ddetail}`}>
                    ...
                    {/* <Calendar studentId={params.sid}/> */}
                    <Calendars studentId={params.sid} userId={params.id}/>
                </div>
              </div>
            </div>
          </div>
...
export default StudentMemberDetail;
