...
const StaffJoiningInfo = () => {
  ...
  const InstituteJoinCodeHandler = () =>{
    axios.post(`${requestURL}/ins/staff/code`, {
      InsId: params.id,
      code: `INST-STA-${randData}`
    })
    .then((res) =>{
                  ...
                  <form className="row">
                    ...
                    <div className="w-100 d-flex justify-content-end ml-5">
                      <button
                        ...
                        onClick={() => navigate(`/joiningdetails/${params.id}`)}
                      >
                    ...
                    <div className="col-12 col-lg-10 col-xl-7 my-4">
                      <div className={styles.hint}>
                        ...
                        <hr />
                        <ol>
                          <li>Must be a Existing Staff of Institute</li>
                          <li>Avail Institute Code from Institute</li>
                    ...
                    <div className="row">
                      ...
                      <div className="col-12 col-md-6 mt-4">
                        <label htmlFor="aicode" className="form-group mb-2">
                          Institute Code <span onClick={StaffRandomCodeHandler} style={{cursor: 'pointer', color: 'black'}}>
                          <img
                      ...
                      <div className="col-12  col-md-6 my-4">
                        <label htmlFor="code" className="form-group mb-2">
                          Current Institute Joining Code
                        </label>
                        <input
                          readOnly
                          type="text"
                          ...
                          className={`form-control `}
                          id="code"
                          value={insData.staffJoinCode ? insData.staffJoinCode : ''}
                        />
                      </div>
                      <div className="col-12 d-flex my-4 justify-content-center">
                        <button
                          ...
                          onClick={InstituteJoinCodeHandler}
                        >
                          Save
                        </button>
                        <button
                          ...
                          onClick={() => navigate(`/staffapplication/${params.id}`)}
                        >
                          Preview
                        </button>
                      </div>
...
export default StaffJoiningInfo;
