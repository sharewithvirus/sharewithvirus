...
import SearchUserCcard from "../SearchUserCcard";
import NavbarTopUser from "../NavbarTopUser";
import NavbarBottomUser from "../NavbarBottomUser";

const SearchUserDepartmentsNewBatch = () => {
                ...
                >
                  ...
                  <div className="row col-11 col-lg-12 col-xl-12 justify-item-center mx-auto">
                      ...
                      <div
                        ...
                        onClick={() =>
                          navigate(
                            `/user/${params.sid}/${params.id}/department/${departmentClassData._id}`
                          )
                        }
                      >
                        <span>
                      ...
                      <div
                        ...
                        onClick={() =>
                          navigate(
                            `/user/${params.sid}/${params.id}/currentbatch/${departmentClassData._id}`
                          )
                        }
                      >
                        <span>
...
export default SearchUserDepartmentsNewBatch;
