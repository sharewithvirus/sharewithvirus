...
const SearchDepartmentCurrentBatch = () => {
                ...
                >
                  ...
                  <div className="row col-11 col-lg-12 col-xl-12 justify-item-center mx-auto">
                      ...
                      <div
                        ...
                        onClick={() =>
                          navigate(
                            `/${params.sid}/${params.id}/department/${params.did}`
                          )
                        }
                      >
                        <span>
                      ...
                      {batchDataText._id ? (
                        <div
                          ...
                          onClick={() =>
                            navigate(
                              `/${params.sid}/${params.id}/departmentclass/${params.did}/batch/${batchDataText._id}`
                            )
                          }
                        >
                          <span>
                  ...
                  >
                    <div className="d-flex justify-content-between my-4">
                      ...
                      <div className="col-5 mt-4 mx-auto d-flex justify-content-end">
...
export default SearchDepartmentCurrentBatch;
