                    ...
                    <div className="row">
                      ...
                      <div className="col-4">
                        <div
                          ...
                          // onClick={() =>
                          //   navigate(
                          //     `/${params.id}/departmentclass/${params.did}/batch/${batchDataText._id}`
                          //   )
                          // }
                        >
                          <span>
                      ...
                      <div className="col-4">
                        <div
                          ...
                          onClick={() =>
                            navigate(
                              `/${params.sid}/${params.id}/currentbatch/${createdepartmentData._id}`
                            )
                          }
                        >
                          <span>
...
export default SearchCreateDepartment;
