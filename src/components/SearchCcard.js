  ...
  return (
    <>
      ...
      <div
        ...
        onClick={() => navigate(`/${props.sid}/ins/${params.id}/department/${params.did}/batch/${params.bid}/class/${ct._id}`)}
      >
...
SearchCcard.defaultProps = {
  imgSrc: "/images/logo-classroom.png",
  cname: "Class Name",
};

export default SearchCcard;
