...
const PostDisplay = (props) => {
  ...
  const DeleteInsPostHandler = (id) => {
    axios
      .delete(
        `${requestURL}/insdashboard/${props.id ? props.id : ""}/ins-post/${id}`
      )
      .then((res) => {
        props.onShowPost(true);
      });
          ...
          props.postData.map((st) =>
            st.CreatePostStatus === "Private" ? (
              ...
              >
                    ...
                    {props.iid && props.uuid ? (
                      <>
                        <span className={styles.threes}>
                          <div
                            id={`edit${st._id}`}
                            className={styles.postEditDeleteData}
                            style={{
                              display: "none",
                              position: "absolute",
                          ...
                          >
                            <ul className={styles.postEditDelete}>
                              <li
                                className={styles.postEditDeleteText}
                                style={{ margin: "10px" }}
                                onClick={() => {
                      ...
                      <>
                        <span className={styles.threes}>
                          <div
                            id={`editIns${st._id}`}
                            className={styles.postEditInsDeleteData}
                            style={{
                              display: "none",
                              position: "absolute",
                              backgroundColor: "lightgray",
                          ...
                          >
                            <ul className={styles.postEditInsDelete}>
                              <li
                                className={styles.postEditInsDeleteText}
                                style={{ margin: "10px" }}
                                onClick={() => {
                                  setAddInsClass(true);
                                }}
                ...
                <p
                  className={` mt-3 px-3 ${styles.dashIcon}`}
                ...
                {st.imageId === "0" ? (
                  ...
                  <div
                    className={`${styles.dashIcon} ${styles.imageBox}`}
                    style={{ width: "810px" }}
                  >
                    <ReactPlayer
          ...
          props.userPostData.map((st) =>
            st.userPostStatus === "Private" ? (
              ...
              >
                ...
                <p
                  className={` px-3 py-2 ${styles.dashIcon}`}
                  style={{ wordBreak: "break-all", whiteSpace: "break-spaces" }}
                >
