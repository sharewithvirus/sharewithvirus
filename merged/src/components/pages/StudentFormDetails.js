...
const StudentFormDetails = () => {
  ...
  useEffect(() => {
    axios
      .get(`${requestURL}/student/${params.id}`)
      .then((res) => {
        setStaffDetails(res.data.student);
        setFirst(true);
      })
      .catch((e) => {
      ...
      <div className={`col col-md-10 col-sm-12 mx-auto`}>
        <div
          className={`${styles.outer2} 
            ${styles.formStyle} `}
        >
          <h4>Student Joining Application </h4>
          <form className="px-5">
              ...
              <img
                src={
                  staffDetails.photoId === "1"
                    ...
                    : first
                    ? `${requestURL}/search/insdashboard/staffdata/photo/${staffDetails.studentProfilePhoto}`
                    : null
                }
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  id="afirstname"
                  name="afirstname"
                  value={staffDetails.studentFirstName}
                />
              </div>
            </div>
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  name="amiddlename"
                  value={
                    staffDetails.studentMiddleName
                      ? staffDetails.studentMiddleName
                      : "NA"
                  }
                />
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  id="alastname"
                  name="alastname"
                  value={staffDetails.studentLastName}
                />
              </div>
            </div>
            <div className="form-group row">
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  id="agender"
                  name="agender"
                  value={staffDetails.studentGender}
                />
              </div>
            </div>
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  id="anational"
                  name="anational"
                  value={staffDetails.studentNationality}
                />
              </div>
            </div>
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  id="aspeak"
                  name="aspeak"
                  value={staffDetails.studentMTongue}
                />
              </div>
            </div>
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  id="acastcat"
                  name="acastcat"
                  value={staffDetails.studentCastCategory}
                />
              </div>
            </div>
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  id="acast"
                  name="acast"
                  value={staffDetails.studentCast}
                />
              </div>
            </div>
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  id="arel"
                  name="arel"
                  value={staffDetails.studentReligion}
                />
              </div>
            </div>
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  id="abirth"
                  name="abirth"
                  value={staffDetails.studentBirthPlace}
                />
              </div>
            </div>
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  id="adistrict"
                  name="adistrict"
                  value={staffDetails.studentDistrict}
                />
              </div>
            </div>
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  id="astate"
                  name="astate"
                  value={staffDetails.studentState}
                />
              </div>
            </div>
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <textarea
                  ...
                  id="aaddress"
                  name="aaddress"
                  value={staffDetails.studentAddress}
                />
              </div>
            </div>
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  id="phone"
                  name="phone"
                  value={`+91 ${staffDetails.studentPhoneNumber}`}
                />
              </div>
            </div>
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  name="aadhar"
                  value={`${
                    staffDetails.studentAadharNumber
                      ? staffDetails.studentAadharNumber
                      : ""
                  }`}
                />
            ...
            {/* <div className="form-group row">
              ...
              <div className="col-5">
                <input
                  ...
                  id="aattach"
                  name="aattach"
                  value={`${staffDetails.studentDocuments} (uploaded)`}
                />
              </div>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  name="aqual"
                  value={
                    staffDetails.studentQualification
                      ? staffDetails.studentQualification
                      : ""
                  }
                />
            ...
            <div className="col-6 d-flex my-4 justify-content-center">
              <button
                ...
                onClick={() =>
                  openInNewTab(
                    `${requestURL}/search/insdashboard/studentdata/adh/${staffDetails.studentAadharCard}`                  )
                }
              >
                View Addhar
              </button>
