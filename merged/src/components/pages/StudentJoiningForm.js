...
const StudentJoiningForm = () => {
  ...
  const [studentJoinData, setStudentJoinData] = useState({
    studentFirstName: "",
    studentMiddleName: "",
    studentLastName: "",
    studentDOB: "",
  ...
  const StudentJoinDataHandler = (e) => {
  ...
  const StudentJoinDataHandlerChange = (e) => {
    e.preventDefault();
    if(studentJoinData.studentDOB >= DOB){
      setStudentJoinData({
        showMessages: true,
    ...
    formData0.append("file", file0[0]);
    formData0.append("fileName", fileName0);
    ...
    axios
      .post(
        `${requestURL}/search/insdashboard/studentdata/${params.sid}`,
        studentJoinData
      )
      .then(async (res) => {
        if (res.data.message) {
          ...
          if (image) {
            await axios.post(
              `${requestURL}/search/insdashboard/studentdata/photo/${id}`,
              formData0
            );
          }
          // await axios.post(
          //   `${requestURL}/search/insdashboard/studentdata/doc/${id}`,
          //   formData
          // );
          await axios.post(
            `${requestURL}/search/insdashboard/studentdata/adh/${id}`,
            formData1
          );
          setOpen(false);
          setStudentJoinData({ showMessages: true, msg: res.data.message });
        }
        setTimeout(() => {
  ...
  return (
    <>
      <Loading open={open} />
      {studentJoinData.showMessages ? (
        <Success msg={studentJoinData.msg} />
      ) : null}
            ...
            <div className={`col col-lg-8 col-xl-9  mx-auto ${styles.midside}`}>
              <div className={`${styles.about}`} style={{ marginTop: "24px" }}>
                ...
                <div className={` ${styles.outer2}`}>
                  <form className="row" onSubmit={StudentJoinDataHandlerChange}>
                    ...
                    <div className="col-12 col-md-4 mt-4">
                      ...
                      <input
                        ...
                        onChange={StudentJoinDataHandler}
                        required
                      />
                    </div>
                    <div className="col-12 col-md-4 mt-4">
                    ...
                    <div className="col-12 col-md-4 mt-4">
                      ...
                      <select
                        ...
                        required
                      >
                        <option value="Select Cast Category" selected disabled>
                    ...
                    <div className="col-12 col-md-4 mt-4">
                      ...
                      <select
                        ...
                        required
                      >
                        <option value="Select Religion" selected disabled>Select Religion</option>
                    ...
                    <div className="col-12 col-md-4 mt-4">
                      ...
                      <select
                        ...
                        required
                      >
                        <option value="Select District" selected disabled>Select District</option>
                    ...
                    <div className="col-12 col-md-4 mt-4">
                      <label htmlFor="pName" className="form-group mb-2">
                        Parent's Name
                        <span className={styles.requireField}>*</span>
                      </label>
                      <input
...
export default StudentJoiningForm;
