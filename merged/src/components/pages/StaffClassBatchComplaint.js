...
const StaffClassBatchComplaint = (props) => {
    ...
    useEffect(() =>{
        ...
        .then((res) => {
          ...
          setClassData(Cdata);
          setComplaintData(res.data.classes.studentComplaint)
        })
        .catch((e) => {
        ...
        {complaintData && complaintData.map((ct) => (
                    <div className={` ${styles.dUser}`}>
                            ...
                            <div>
                                ...
                                <span >{ct.createdAt ? moment(ct.createdAt).format('DD/MM/YYYY') : ''}</span>
                                </>
                                :
                                <>
...
export default StaffClassBatchComplaint