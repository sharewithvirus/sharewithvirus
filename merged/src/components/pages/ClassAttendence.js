...
const ClassAttendence = (props) => {
  ...
  const [cAttendDate, setCAttendDate] = useState("");
  const [cAttendReg, setCAttendReg] = useState("");
  ...
  const AttendenceHandlerChange = (e) => {
    e.preventDefault();
    axios
      .post(
        `${requestURL}/class/${params.cid}/student/attendence`,
        attendenceData
      )
      .then((res) => {
        setCAttendDate(res.data.attendDate);
        setCAttendReg(res.data.attendReg);
              ...
              <div className={`${styles.about}`}>
                ...
                <div className={`${styles.outer2} mt-4`}>
                  ...
                  <div className={`my-4 ${styles.ddetail}`}>
                    ...
                    <hr />
                    <h4 className="my-3">Attendence Sheet</h4>
                    <form onSubmit={AttendenceHandlerChange}>
