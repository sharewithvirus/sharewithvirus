            ...
            <div className={`col col-lg-8 col-xl-9  mx-auto ${styles.midside}`}>
              <div className={`${styles.about}`} style={{ marginTop: "24px" }}>
                ...
                >
                  ...
                  <NewDetailsBar cData={createClassData} />
                  ...
                  <div className={`mb-5 ${styles.ddetail}`}>
                    <div className="row">
                      ...
                      <span
                        ...
                        onClick={() =>
                          navigate(
                            `/user/${params.sid}/ins/${params.id}/department/${params.did}/batch/${params.bid}/classsubject/${params.cid}`
                          )
                        }
                      >
...
export default SearchUserCreateClass;
