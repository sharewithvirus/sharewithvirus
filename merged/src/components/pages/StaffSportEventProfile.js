                  ...
                  <form className="row mt-5">
                    ...
                    <div className="row d-flex justify-content-between">
                      ...
                      <button
                        ...
                        >
                          <i class="far fa-plus-square mt-1 mx-2"></i> Add Event
                        </button>
                      </div>
                    </div>
                    <div className={` gx-0 mt-5  ${styles.cardContainer} `}>
                      {sportData.sportEvent &&
                        sportData.sportEvent.map((st) => (
                          <>
                          <div
                    ...
                    { 
                            ...
                            <img
                              ...
                              alt="classroom"
                              onClick={() => navigate(`/user/${params.id}/staff/${params.sid}/sport/${params.ssid}/event/${st._id}`)}

                            />
                            <p className={styles.dlogoText}>
                              <small>
                                {st.sportEventName ? `${st.sportEventName} Event` : ""}
                              </small>
                            </p>
                          </div>
                           </>
...
export default StaffSportEventProfile;
