            ...
            <div className={`col col-lg-8 col-xl-9  mx-auto ${styles.midside}`}>
              <div className={`${styles.about}`} style={{ marginTop: "24px" }}>
                ...
                >
                  ...
                  <NewDetailsBar cData={createClassAboutData} />
                  ...
                  <div className={`mb-5 ${styles.ddetail}`}>
                    <div className="row">
                      <span
                        ...
                        onClick={() =>
                          navigate(
                            `/user/${params.sid}/ins/${params.id}/department/${params.did}/batch/${params.bid}/class/${params.cid}`
                          )
                        }
                      >
                  ...
                  <form className="row mt-0">
                    <div className="d-flex justify-content-between">
                      ...
                      <div className="d-flex col-6 mt-2 justify-content-end"></div>
                    </div>
...
export default SearchUserClassSubject;
