...
export default function BookCard(props) {
  ...
  // console.log("This is current time: ", moment(d).format("DD/MM/YYYY"));
  // console.log("THis is mongoose date", props.date);
  // // const my = props.date;
  // // console.log("THis is mongoose date", my);
  // // my.setDate(my.getDate() + 5);
  // console.log("This is my time: ", moment(props.date).format("DD/MM/YYYY"));
