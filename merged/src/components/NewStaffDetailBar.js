        ...
        <div className={styles.barMainrow}>
          ...
          >
            <div className={` ${styles.barInnersLeft} ${styles.barLeftShort}`}>
              <p>{props.staffDepart.length + props.staffClass.length + props.staffSubject.length}</p>
              <p>Designation</p>
            </div>
...
NewStaffDetailBar.defaultProps = {
    name:"Staff Name",
    // sFirst:"Class",
    // sFirstCount:12,
    // sSecond:"Students",
...
export default NewStaffDetailBar;
